...
patientsController.get("/", (req: Request, res: Response) => {
  ...
  if (isString(rawZipCode)) {
    LoggerService.info(`Filtrage des patients par code postal : ${rawZipCode}`);
    ...
    LoggerService.info("Aucun filtre fourni, renvoi de la liste complète.");
